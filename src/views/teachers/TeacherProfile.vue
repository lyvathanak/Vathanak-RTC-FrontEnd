          ...
          <div v-else class="space-y-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              <InfoCard
                ...
                subtitle="Teacher academic records"
                :icon="GraduationCap">
...
async function fetchProfile() {
  try {
    ...
    // Teacher sub_department is null in your response
    profile.subDepartment = ud?.sub_department?.name || "-";

    // Teacher response has NO program/promotion/current_programs
    profile.program = "-";
    profile.promotion = "-";
    profile.grade = "-";
  } catch (err) {
