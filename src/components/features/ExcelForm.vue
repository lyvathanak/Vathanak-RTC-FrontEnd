<template>
  <button @click="exportToExcel" class="inline-flex items-center justify-center gap-2 rounded-lg border bg-[#235AA6] text-white px-3 sm:px-4 py-2.5 transition text-sm font-medium whitespace-nowrap">
...
<style scoped>
/* Responsive button styles are now handled via Tailwind classes */
</style>