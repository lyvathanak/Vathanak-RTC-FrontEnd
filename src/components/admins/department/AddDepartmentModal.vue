  ...
  <transition name="fade">
    <div
      ...
      <div
                  ...
                  <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        class="w-full rounded-lg border px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        :class="
                          sd._errName ? 'border-red-400' : 'border-gray-300'
                        " />
                      <p v-if="sd._errName" class="text-xs text-red-600 mt-1">
                        Name is required.
                      </p>
                    </div>
        ...
        <!-- Footer -->
        <div
          class="px-6 py-4 border-t bg-gray-50 flex items-center justify-end gap-3">
          <button
            class="px-4 py-2.5 rounded-lg border border-gray-300 bg-red-600 text-white hover:bg-red-700"
            @click="onClose"
            :disabled="saving">
            Cancel
          </button>
