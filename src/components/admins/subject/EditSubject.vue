      ...
      <div
        ...
        <div
          ...
          <div class="px-6 py-5 space-y-6 max-h-[70vh] overflow-y-auto">
            <div
              v-if="errors.submit"
              class="rounded-lg bg-red-50 text-red-700 px-4 py-3 text-sm">
              {{ errors.submit }}
            </div>
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <p v-if="errors.subject_name" class="text-xs text-red-600">
                    {{ errors.subject_name }}
                  </p>
                </div>
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    disabled
                    class="w-full rounded-lg border px-3 py-2.5 outline-none bg-gray-50 text-gray-700" />
                  <p v-if="errors.department_id" class="text-xs text-red-600">
