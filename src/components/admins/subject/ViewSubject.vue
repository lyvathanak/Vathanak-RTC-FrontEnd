...
<template>
  <Teleport to="body">
    <div
      ...
      <div
        class="relative mt-6 w-[min(980px,95vw)] rounded-2xl bg-white shadow-xl overflow-hidden">
        <!-- Header -->
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div
                  class="w-full rounded-lg border px-3 py-2.5 bg-gray-50 text-gray-700 flex items-center justify-between">
                  <span class="truncate">{{
              ...
              <div class="md:col-span-2 flex flex-col gap-1">
                ...
                <textarea
                  ...
                  rows="3"
                  class="w-full rounded-lg border px-3 py-2.5 outline-none bg-white disabled:bg-gray-50 disabled:text-gray-700 resize-y"></textarea>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="rounded-xl border overflow-hidden mb-3">
              <table class="w-full">
                <thead class="bg-gray-50">
                  <tr>
                    <th
                      class="text-left text-sm font-medium text-gray-600 px-4 py-3">
                      Name
                    </th>
                    <th
                      class="text-left text-sm font-medium text-gray-600 px-4 py-3">
                ...
                <tbody class="divide-y">
                  <tr
                    ...
                    <td class="px-4 py-3">
                      <button
                        ...
                        :title="
                          isRemoving(t.id) ? 'Unassigning…' : 'Unassign teacher'
                        "
                  ...
                  <tr v-if="!teachers.length">
                    <td colspan="4" class="px-4 py-3 text-sm text-gray-500">
            ...
            <div class="flex flex-col md:flex-row gap-2 md:items-center">
              <div class="flex-1">
                <div class="relative">
                  <select
                    ...
                    class="w-full rounded-lg border px-3 py-2.5 outline-none bg-white appearance-none pr-10">
              ...
              <button
                ...
                <span
                  v-if="assigning"
                  class="inline-block h-4 w-4 border-2 border-white/80 border-t-transparent rounded-full animate-spin mr-2"></span>
                Assign Teacher
              </button>
            </div>
            <p v-if="assignError" class="text-sm text-red-600 mt-2">
              {{ assignError }}
            </p>
          </div>
        </div>
        ...
        <!-- Footer -->
        <div
          class="px-6 py-4 border-t flex items-center justify-end gap-2 bg-gray-50">
          <button
            class="rounded-md bg-red-500 hover:bg-red-600 text-white px-4 py-2.5"
            @click="close">
            Close
          </button>
          <button
            class="rounded-md bg-[#235AA6] hover:bg-[#1e4a94] text-white px-4 py-2.5"
            @click="edit">
            Edit
          </button>
        </div>
