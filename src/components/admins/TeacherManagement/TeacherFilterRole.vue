<template>
  <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
    ...
    <div class="flex items-center justify-between gap-3 px-4 py-3 sm:px-5">
      ...
      <!-- Clear button (same style you want) -->
      <button
        type="button"
...
/** Internal state keeps "All" like your current logic */
...
/**
 * BaseSelect uses "" for All, but we keep "All" internally
 */
...
/** Options => BaseSelect items: [{label,value}] */
...
/**
 * Emit clean query like your parent expects:
 * { department_id, program_id, academic_year, origin, gender }
 */
function emitClean() {
...
/** Watch department changes (safety) */
watch(
