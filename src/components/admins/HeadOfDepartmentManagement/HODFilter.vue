<template>
  <Filter class="px-3 sm:px-5"
    :key="filterKey"
    :filter-definitions="hodFilterDefinitions"
    :initial-filters="initialHODFilters"
...
// HOD-specific filter definitions using dynamic data
const hodFilterDefinitions = computed(() => {
...
// Initial filter values for HODs
const initialHODFilters = computed(() => ({
