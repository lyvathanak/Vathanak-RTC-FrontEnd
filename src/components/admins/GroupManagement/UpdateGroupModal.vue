        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p v-if="errors.section_id" class="text-red-500 text-xs mt-1">
                {{ errors.section_id }}
              </p>
              <p
                v-if="!groupForm.department_id"
          ...
          <div>
            ...
            <p v-if="errors.semester_id" class="text-red-500 text-xs mt-1">
              {{ errors.semester_id }}
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"></textarea>
          </div>
        </div>
      </div>
...
const resetForm = async () => {
  ...
  groupForm.value = {
    ...
    section_id:
      g.sub_department_id ?? g.section_id ?? g.sub_department?.id ?? null,
