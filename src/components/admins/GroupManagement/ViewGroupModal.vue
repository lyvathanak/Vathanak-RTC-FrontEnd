    ...
    <div
      ...
      <div class="p-6 border-b border-gray-200" v-if="resolvedGroupData">
        <div
          ...
          <div>
            ...
            <div class="mt-1">
              <span
                v-if="resolvedGroupData.department_name !== 'N/A'"
                class="text-gray-900"
                >{{ resolvedGroupData.department_name }}</span
              >
          ...
          <div>
            ...
            <div class="mt-1">
              <span
                v-if="resolvedGroupData.program_name !== 'N/A'"
                class="text-gray-900"
                >{{ resolvedGroupData.program_name }}</span
              >
          ...
          <div>
            ...
            <div class="mt-1">
              <span
                v-if="resolvedGroupData.section_name !== 'N/A'"
                class="text-gray-900"
                >{{ resolvedGroupData.section_name }}</span
              >
          ...
          <div>
            ...
            <div class="mt-1 flex items-center gap-2">
              ...
              <span v-if="semesterDates" class="text-gray-500 text-xs">{{
                semesterDates
              }}</span>
            </div>
          </div>
        ...
        <div class="mt-4" v-if="resolvedGroupData.description">
          ...
          <div class="mt-1 text-gray-900 bg-gray-50 p-3 rounded-lg">
        ...
        <div v-else-if="studentsList.length === 0" class="p-8 text-center">
          <div class="text-gray-500">
            <div v-if="studentCount > 0" class="mb-2">
              <p class="text-lg">
                This group has
                <strong class="text-gray-700">{{ studentCount }}</strong>
                {{ studentCount === 1 ? "student" : "students" }}
              </p>
              <p class="text-sm text-gray-400">
                but student details could not be loaded
              </p>
            </div>
            <div v-else>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <AlertDialog>
                  <AlertDialogTrigger as-child>
                    <button
                      :disabled="
                        isRemoving || removingStudents.includes(student.id)
                      "
                      ...
                      :title="
                        isRemoving ? 'Processing...' : 'Remove from group'
                      ">
                      <div
      ...
      <div
        ...
        <div class="flex items-center gap-4 text-sm text-gray-600">
          <span
            >Total students:
            <strong class="text-gray-900">{{ studentCount }}</strong></span
          >
          <span v-if="loading" class="flex items-center gap-1">
            <div
              class="animate-spin rounded-full h-3 w-3 border-b-2 border-blue-600"></div>
            Loading...
          </span>
          <span
            v-else-if="studentsList.length !== studentCount && studentCount > 0"
