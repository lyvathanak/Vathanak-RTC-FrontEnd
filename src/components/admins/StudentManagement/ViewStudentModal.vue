                ...
                <div class="bg-white rounded-xl p-3 sm:p-4 shadow-sm">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <div
                        class="w-full rounded-md bg-gray-100 px-3 py-2 text-sm text-gray-800">
                        {{ student.latin_name || "—" }}
                      </div>
                    </div>
                    <div>
                      ...
                      <div
                        class="w-full rounded-md bg-gray-100 px-3 py-2 text-sm text-gray-800 khmer-text">
                        {{ student.khmer_name || "—" }}
                      </div>
                    </div>
                    <div>
            ...
            <div
              ...
              <div
                ...
                <button
                  ...
                  <div
                    v-if="student.id_card"
                    class="text-[10px] sm:text-[11px] text-gray-400 mt-1">
                    {{ student.id_card }}
                  </div>
                </button>
              </div>
  ...
  <transition name="fade">
    <div
      ...
      <div class="relative max-w-[90vw] max-h-[90vh]" @click.stop>
        ...
        <img
          :src="imageSrc"
          :alt="student?.latin_name || 'Student photo'"
...
const { departments, getAllDepartments, departmentLoading } = useDepartment();

const { programs, getAllPrograms, loading: programLoading } = useProgram();
...
const getSectionName = (id) => {
  try {
    ...
    const result = section
      ? section.name || section.sub_department_name
      : "N/A";
  ...
  try {
    ...
    // If it's in DD/MM/YYYY format, convert to MM/DD/YYYY for Date parsing
      ...
      if (parts.length === 3) {
        ...
        if (
          first > 12 ||
          (first <= 12 && second <= 12 && parts[2].length === 4)
        ) {
